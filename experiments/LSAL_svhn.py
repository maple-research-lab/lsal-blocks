...
from bricks_savemargin import (ALI, GaussianConditional, DeterministicConditional,
...
def create_model_brick():
    ...
    ali.initialize()
    #tmp= create_svhn_data_streams(500, 500)[0].get_epoch_iterator()
    #print('tmp :',tmp)
    raw_marginals, = next(
        create_svhn_data_streams(500, 500)[0].get_epoch_iterator())
    #print('tmp :',raw_marginals.shape)
